...
groups = [
    ...
    Group(name='s', label=''),
    Group(name='t', label=''),
    Group(name='l', label='', matches=[Match(wm_class="signal")], layout="columns"),
    Group(name='u', label='', matches=[Match(wm_class="spotify")], layout="columns"),
]
...
def create_widget():
    return [
        ...
        widget.UnitStatus(
            ...
            mouse_callbacks = {
                "Button1": lazy.spawn("systemctl restart emacs.service"),
            },
            ,**widget_defaults,
        ),
        widget.Spacer(length = 12),
...
wall = "~/.dotfiles/wallpapers/mountain_uw.jpg"
