  ...
  services.conky = {
    ...
    extraConfig = ''
      ...
      conky.config = {
        ...
        own_window_colour = '#${colors.base00}', -- set colour if own_window_transparent no
        own_window_transparent = false,      -- if own_window_argb_visual is true sets background opacity 0%
        own_window_title = 'nixos_conky',    -- set the name manually
        own_window_type = 'override',        -- if own_window true options are: normal/override/dock/desktop/panel
        own_window_hints = 'undecorated,below,above,sticky,skip_taskbar,skip_pager', -- if own_window true - just hints

        --Colors (using nix-colors theme)
        color0 = '#${colors.base0E}',        -- purple for headings
        color1 = '#${colors.base05}',        -- foreground for text
        color2 = '#${colors.base0D}',        -- blue for bars
        color3 = '#${colors.base0B}',        -- green for titles
      };
      ...
      ''${voffset 18}''${color1}''${alignc}''${font4}NIXOS KEYBINDINGS''${font}''${color}
      ''${color1}''${hr}''${color}
      ...
      ''${color1}''${hr}''${color}
      ''${color1}[S]+[SHIFT]+r''${alignr}''${color2}restart wm''${color}
      ''${color1}[S]+[SHIFT]+q''${alignr}''${color2}quit wm''${color}
      '';
    '';
  };
}
