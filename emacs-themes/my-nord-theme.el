;;; themes/my-nord-theme.el -*- lexical-binding: t; -*-
...
(def-doom-theme my-nord
  ...
  ((bg         '("#2E3440" nil       nil            ))
   ...
   (grey       base4)
   (red        '("#E06C75" "#ff6655" "red"          )) ;; Nord11
   (orange     '("#dd8844" "#dd8844" "brightred"    )) ;; Nord12
   (green      '("#99bb66" "#99bb66" "green"        )) ;; Nord14
   (teal       '("#8FBCBB" "#44b9b1" "brightgreen"  )) ;; Nord7
   (yellow     '("#ECBE7B" "#ECBE7B" "yellow"       )) ;; Nord13
   (yellow2    '("#E5C07B" "#ECBE7B" "yellow2"       )) ;; Nord13
   (blue       '("#569ece" "#51afef" "brightblue"   )) ;; Nord9
   (dark-blue  '("#444e91" "#2257A0" "blue"         )) ;; Nord10
   (magenta    '("#c678dd" "#c678dd" "magenta"      )) ;; Nord15
